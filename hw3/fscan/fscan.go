...
import (
	...
	"encoding/hex"
	"fmt"
	"github.com/AbnormalReality/GB_best_go3/hw3/mockfs"
...
// Edit - вводит новый дубликат в соотв. элемент FileElem
...
// DeleteDup физическое удаление дубликата
...
// для каждой подпапки запускает саму себя, выделяя новый поток
